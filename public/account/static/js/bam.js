...
var UI = {
    ...
    initialize: function(parent) {
        ...
        UI.downloadLinks = $('[data-event-type="download"]', UI.parent);
        ...
        if (UI.downloadLinks.length > 0) {
            UI._initializeDownloadLinks();
        }
    ...
    _initializeDownloadLinks: function() {
        var gaUid = ga.getAll()[0].get("clientId");
        var downloadLink,
            downloadLinkHref;
        for (var i = 0; i < UI.downloadLinks.length; i++) {
            downloadLink = $(UI.downloadLinks[i]);
            downloadLinkHref = downloadLink.prop("href");
            if (downloadLinkHref.search("getInstallerForGame") > -1) {
                downloadLink.prop("href", downloadLinkHref + "&id=" + gaUid);
            }
        }
    },
