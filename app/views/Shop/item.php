<style>
    ...
    html,
    body {
        background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1920.jpg") no-repeat center -200px !important;
    }
    .body-content {
        background: none !important;
    }
    .navbar-static {
        background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1920.jpg") no-repeat center 0 !important;
    }
    @media (max-width: 1280px) {
        html,
        body {
            background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1280.jpg") no-repeat center -200px !important;
        }
        .body-content {
            background: none !important;
        }
        .navbar-static {
            background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1280.jpg") no-repeat center 0 !important;
        }
    }
    @media (max-width: 1024px) {
        html,
        body {
            background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1024.jpg") no-repeat center -200px !important;
        }
        .body-content {
            background: none !important;
        }
        .navbar-static {
            background: <?=$itemData['item_background_color']?> url("/images/shop/items/<?=$itemData['item_background']?>_1024.jpg") no-repeat center 0 !important;
        }
    }
</style>
